...
export const COMPRESS_PRESETS = [
    {
        ...
        name: '이어진 반복이 많다',
        text: 'AAAAABBCCC',
        hint: '같은 글자가 붙어 있습니다. 런 렝스가 노리는 모양이고, 강의노트에서 든 예와 같은 글입니다.',
    },
    {
        id: 'flat',
        name: '이어지지 않고 반복된다',
...
export const COMPRESS_METHODS = [
    {
        ...
        notes: [
            '가지런한 칸이 <b>원본</b>이고, 아래에 쌓이는 것이 <b>압축 결과</b>입니다.',
    ...
    },
    {
        ...
        notes: [
            ...
            '루트에서 단말 노드까지 걸어가며 <b>왼쪽 0, 오른쪽 1</b>을 모은 것이 그 글자의 코드입니다.',
    ...
    },
    {
        ...
        notes: [
            '「현재 글」 줄에서 <b>바뀐 자리가 기호로 바뀌어 갑니다.</b> 위의 「압축 전」은 그대로 둡니다 — '
