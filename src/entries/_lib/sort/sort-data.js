...
/* **고를 수 있는 개수. 고르게 분포시키지 않는다.**
 *
 * 수업에서 실제로 쓰는 자리는 2~20이다 — 한 단계씩 넘겨 가며 무슨 일이 벌어지는지
 * 보려면 그만큼이어야 한다. 그런데 2~1000을 고르게 분포시킨 슬라이더에서는 그 구간이
...
/** **기본값은 「한 회차가 100단계 안에서 끝나는 크기」로 잡았다.**
 *
...
export const SORT_PRESETS = [
    {
        id: 'random',
        name: '무작위',
        hint: '아무 순서 없이 섞인 자료. 비교할 때의 기준이 된다.',
    },
    {
        id: 'nearly',
        name: '거의 정렬됨',
        /* **「유일한 자리」라고 적지 않는다.** 「값이 몇 종류뿐」에서도 삽입 정렬이
           퀵 정렬을 이기는 경우가 흔하다(측정해 보면 열에 예닐곱). 여기서 눈여겨볼 것은
           이기느냐가 아니라 **격차가 몇 곱절로 벌어진다**는 쪽이다. */
        hint: '몇 자리만 어긋나 있다. 삽입 정렬이 퀵 정렬을 몇 곱절로 앞지른다.',
    },
    {
        id: 'reversed',
        name: '역순',
