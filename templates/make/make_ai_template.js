...
const makeQ5 = (c) => [
    ...
    questionTable(
        [
            run("문항 5.  ", {bold: true}),
            run("수집한 데이터로 모델을 학습시킨 결과를 서술하시오. 학습이 완료된 화면 또는 학습 결과(정확도·손실 등)를 스크린샷으로 첨부하고, 결과의 의미를 간략히 설명하시오."),
            run("\n\n〈화면 캡처 단축키: 윈도우 + Shift + S〉",
                {size: FONT_SMALL, color: "555555", italics: true}),
        ],
    ...
    checklistBox([
        ...
        "정확도·손실·신뢰도 등 학습 결과 수치가 구체적으로 언급되어 있다.",
...
if (require.main === module) {
    makeDocument("../ai/ai_ml_template.docx");
}
