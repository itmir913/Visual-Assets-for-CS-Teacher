...
# 아직 손질하지 않아 검사에서 빼 두는 폴더. **비어 있는 것이 목표다.**
# simulator/ai는 이 감사(2026-08-26)의 범위 밖이었다. 손질하는 대로 여기서 뺀다.
PENDING = ["simulator/ai", "src/entries/simulator/ai"]
...
SIM_TERMS = [
    ...
    (r"한 판|앞 판|판마다|이 판|그 판|판이 끝", "판", "회차"),
]
