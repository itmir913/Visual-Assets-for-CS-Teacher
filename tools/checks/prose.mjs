...
const VERBS = [
    ...
    ['앞세(?:우|워|웠|웁|운|울)', '앞세우다', '우선하다',
        ['MAE를 앞세웁니다', '가장 앞세우는', '앞세운다는'], ['앞서 세운']],
    ['흩뿌(?:리|려|렸|린|릴|림)', '흩뿌리다', '흩어 놓다',
        ['흩뿌려 보세요', '흩뿌린 데이터', '흩뿌려짐'], ['흩어 놓은']],
    [H + '헛(?:돌[다고며면아았지기]|돈다|돕|돌 |돈 |돌았|돌아)', '헛돌다', '소용없어지다 · 제대로 작동하지 않다',
        ['뒤가 다 헛돈다', '모두 헛돕니다', '헛돌고'], ['헛수고']],
    [H + '캐(?:내|냅|낸|냈|낼)', '캐내다', '추출하다 · 찾아내다',
        ['캐내는 쪽', '규칙을 캐냅니다'], ['캐시']],
    ['끄집어\\s?(?:내|냅|낸|냈|낼)', '끄집어내다', '꺼내다',
        ['끄집어내는 일'], []],
    [H + '엿(?:보|봅|봐|봤|볼|본)', '엿보다', '몰래 보다 · 가로채다',
        ['중간에서 엿보거나', '화면을 엿보고'], ['엿새']],
    [H + '빗(?:대|댄|댑|댈)', '빗대다', '비유하다',
        ['사람에 빗대어', '자물쇠에 빗대면'], ['빗자루']],
    [H + '떠안', '떠안다', '부담하다 · 감수하다',
        ['문제까지 떠안게'], []],
    [H + '되밟', '되밟다', '되돌아가다',
        ['간선을 되밟지'], []],
    [H + '도사(?:리|린|립|려)', '도사리다', '숨어 있다',
        ['위험이 도사리는'], ['도사']],
];
